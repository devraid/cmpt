...
window.Typekit.config = {
    "c": [".tk-proxima-nova", "\"proxima-nova\",sans-serif", ".tk-alternate-gothic-no-1-d", "\"alternate-gothic-no-1-d\",sans-serif"],
    "f": "//fonts.fandango.com/k/c/kpn3yzj-{format}.css",
    "fn": ["alternate-gothic-no-1-d", ["n4"], "proxima-nova", ["i4", "n4", "n7"]],
    "p": "//p.typekit.net/p.gif?s=2&k=kpn3yzj&ht=tk&h={host}&f=139.175.176.10326&a=956477&_={_}"
};
...
(function(window, document, undefined) {
    ...
    la.prototype.parse = function() {
        ...
        if (-1 != this.e.indexOf("MSIE")||-1 != this.e.indexOf("Trident/")) {
            a = z(this);
            var b = A(this), c = x(b), d = k, e = k, f = k, g = k, h = D(this.e, /Trident\/([\d\w\.]+)/, 1), p = E(this.R), d =- 1 != this.e.indexOf("MSIE") ? D(this.e, /MSIE ([\d\w\.]+)/, 1) : D(this.e, /rv:([\d\w\.]+)/, 1), e = x(d);
            ...
            a: if (a = "Unknown", b =
            D(this.e, /Presto\/([\d\w\.]+)/, 1)
                , c = x(b), d = A(this), e = x(d), f = E(this.R), c.g !== k ? a = "Presto" : (-1 != this.e.indexOf("Gecko") && (a = "Gecko"), b = D(this.e, /rv:([^\)]+)/, 1), c = x(b)), -1 != this.e.indexOf("Opera Mini/"))g = D(this.e, /Opera Mini\/([\d\.]+)/, 1), h = x(g), a = new y("OperaMini", h, g, a, c, b, z(this), e, d, f, new t(l, l, l));
        else {
    ...
    function A(a) {
        ...
        if (b || (b = D(a.e, /Windows Phone( OS)? ([^;)]+)/, 2)) || (b = D(a.e, /(iPhone )?OS ([\d_]+)/, 2)))
            return b;
    ...
    function pa(a) {
        var b = z(a), c = A(a), d = x(c), e = D(a.e, /AppleWeb(?:K|k)it\/([\d\.\+]+)/, 1), f = x(e), g = "Unknown", h = new u, p = "Unknown", K = l;
        ...
        return new y(g, h, p, "AppleWebKit", f, e, b, d, c, E(a.R),
        new t(K, 536 > f.g || 536 == f.g && 11 > f.o, "iPhone" == b || "iPad" == b || "iPod" == b || "Macintosh" == b))
    }
    function D(a, b, c) {
    ...
    function va(a, b, c, d, e, f, g, h) {
        ...
        ua(a);
        for (var p in L)
            L.hasOwnProperty(p) && (ta(a, new I(L[p], G(this.C))), this.P[L[p]] = a.D.offsetWidth);
        a.remove()
    }
    var L = {
        fb: "serif",
    ...
    M.prototype.Ca = function(a) {
        var b = this.G, c = ia(b.v, b.q.m(b.r, a.getName(), G(a).toString(), "active")), d = [], e = [b.q.m(b.r, a.getName(), G(a).toString(), "loading")];
    ...
    O.prototype.m = function(a, b) {
        var c = b || {}, d = this.Ua.replace(/\{\/?([^*}]*)(\*?)\}/g, function(a, b, d) {
    ...
    var V = {
        ...
        b: function(a) {
            return Oa(a) && S(a) || "AdobeAIR" === a.getName() && w(a.A,
            new u(2, 5)) && S(a)
        },
        d: function(a, b) {
            ...
            a.getName() && 9 <= a.S && (P(a) && w(a.l, new u(6, 1)) || P(a) && 0 === v(a.l, new u(6, 0))) || "MSIE" === a.getName() && b.za && "Windows Phone" === a.n && w(a.l, new u(8)) || Pa(a) && (b.la && "BlackBerry" === a.n && w(a.l, new u(10)) || U(a))
        },
        j: function(a, b) {
    ...
    Y.prototype.load = function(a, b, c) {
        if (this.s) {
            for (var d = Ua[this.s] || new Ra(Sa), e = 0; e < this.u.length; e++) {
                for (var f = this.u[e], g = this.s, h = d, p = [], K = f.L.split(",")[0].replace(/"|'/g, ""), C = f.H(), Q = p, B = void 0, H = [], Qa = {}, na = 0; na < C.length; na++)
                    B = C[na], 0 < B.length&&!Qa[B] && (Qa[B] = j, H.push(B));
                C = H;
                h = h.wa ? h.wa(K, C, Q) : C;
                f.pa[g] = h;
                f.oa[g] = p
            ...
            if (a) {
                var oa = this, lb = this.s;
                ha(this.h, function() {
                    for (var c = 0; c < oa.u.length; c++)
                        oa.u[c].ga(a, lb, b && c == oa.u.length-1)
                })
            }
        }
    };
    Y.prototype.collectFontFamilies = function(a, b) {
        if (this.s)
            for (var c = 0; c < this.u.length; c++)
                Fa(this.u[c], this.s, a, b)
    };
    Y.prototype.performOptionalActions = function() {
        if (this.da) {
            var a = this, b = this.e, c = this.h;
            ha(this.h, function() {
                var d = a.da;
                if (d.va) {
                    var e = window.__adobewebfontsappname__, e = e ? e.toString().substr(0, 20): "", d = d.va.m(s(c), {
    ...
    function Wa(a, b) {
        if (0 != a.t.length) {
            a.ma = b.contextPath || ".";
            for (var c = new ra(a.h, a.v, b), d = l, e = 0; e < a.t.length; e++)
    ...
    Ya.prototype.m = function(a, b) {
        ...
        if ("MSIE" == a.getName() && "Windows Phone" != f) {
            ...
            var g = this, h = function() {
                var a = $a(g, "scrollLeft", "scrollTop"), b = $a(g, "clientWidth", "clientHeight");
                c.style.bottom = "auto";
                c.style.right = "auto";
    ...
    if (!window.Typekit.load) {
        var bb = window.Typekit.config || {}, cb = k;
        bb.k && (cb = new O(bb.k));
        var db = new Va(cb, new ga(window), ab, document.documentElement), eb = new Xa(window);
    ...
    var fb, gb = k, hb = k, ib = k, jb, Z, $, N = window.Typekit.config || {};
    ...
    if (N.fn)
        for (i = 0; i < N.fn.length; i += 2)
            $.u.push(new Ea(N.fn[i], N.fn[i + 1]));
    if (N.c)
        for (i = 0; i < N.c.length; i += 2)
            $.Q.push(new Aa);
    var kb;
    if (kb = eb)
        kb=!!eb.I.__webfonttypekitmodule__;
